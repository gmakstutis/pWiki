...
- 'Learning takes place through the active behaviour of the student: it is what he (sic) does that he learns, not what the teacher does.' (Tyler, 1949) (p. 6).
- 'What the student does is actually more important in determining what is learned than what the teacher does.' (Shuell, 1986) (p. 7).
- The term 'constructive' is used because the model is based on the psychology of constructivism — knowledge is constructed through the activities of the learner (p. 8).
- The term 'alignment' is used because both teaching and assessment need to be aligned to the intended learning outcomes (p. 8).
...
- For CA to work properly, it needs to be embedded in a supportive culture, at each of departmental, faculty, institutional levels and even national levels (p. 10).
- Constructively aligned teaching seems to produce high quality learning outcomes and student satisfaction (p. 13).
- In high CA units students were significantly more likely to adopt deep approaches to learning and less likely to use surface approaches compared to students in low CA units (Wang et al., 2013) (p. 13).
- The most important development since CA was first published is its incorporation into institutional teaching policy (p. 14).
- One of the greatest problems is finance and attendant staff workloads (p. 15).
- Another problem is teacher resistance to change (p. 15).
- Quality enhancement subsumes quality assurance; whereas QA is reactive, QE is proactive (p. 18-19).

## Connections

**Concepts:** [Constructive Alignment](../concepts/constructive-alignment.md) · [Intended Learning Outcomes](../concepts/intended-learning-outcomes.md) · [Assessment](../concepts/assessment.md) · [Deep Learning](../concepts/deep-learning.md) · [Surface Learning](../concepts/surface-learning.md)
**Authors:** [John Biggs](../authors/biggs.md)
**Debates:** [Deep vs Surface Learning](../debates/deep-vs-surface-learning.md) · [Formative vs Summative Assessment](../debates/formative-vs-summative-assessment.md)
