...
- The emphasis on "teaching" can cause us to overlook that the main purpose of teaching is to promote student learning (p. 2).
- A checklist/proforma is suggested to avoid vague, anecdotal feedback, but since most genuine peer observation is developmental, a more open, informal recording measure should also be incorporated (p. 2).
- The pre-observation meeting is essential to the success of the process, used to develop trust and resolve anxieties (p. 4).
- The observer is not there to assess teaching; outcomes are confidential between participants unless both agree to make them public (p. 5).
- Feedback should be as immediate and informal as possible, kept to the areas requested, and use phrases like "It seemed to me..." rather than "This was bad..." (p. 8-9).
- Without implementing some aspect of the observation, the process becomes "a pointless paper exercise" (p. 10).
- Peer observation in universities became a feature since the millennium; it was common in the USA in the 1960s, developed in the UK in the 1990s, and took an additional ten years to infiltrate third-level education in Ireland (p. 1).

## Connections

**Concepts:** [Peer Observation](../concepts/peer-observation.md) · [Reflective Practice](../concepts/reflective-practice.md) · [Feedback](../concepts/feedback.md)
**Authors:** [David Gosling](../authors/gosling.md)
