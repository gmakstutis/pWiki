...
- African-Caribbeans were positioned within a racialised working class, reflective of the essentialism of earlier historical accounts (p. 45).
- Wallace (2018) draws attention to the association of whiteness with the valorised cultural capital of the white middle class, which serves to marginalise the capital of the black middle class (p. 45).
- The concept of 'warehousing' refers to the way in which particular fractions of working-class youth were effectively 'parked' on youth training schemes and low-level VET, effectively 'eliminated' from the labour market (p. 46).
- Total participation rates in FE/VET in England have fallen by 30 per cent from 4.7 million in 2002/03 to 3.3 million in 2015/16, suggesting the increasing marginalization of Further Education in the English educational landscape (p. 46).
- Some black students relied on 'cold knowledge' sources such as Google for initial information on VET pathways, rather than on teachers or family networks (p. 47).
- For some working-class students, decisions to enter FE are shaped as much by students' sense of what they cannot achieve as what they can achieve (Thompson, 2009) (p. 48).
- Black students in fields such as hair and beauty sometimes found that their specific interests were not catered for, and that their VET qualifications left them on the periphery of the sector (p. 48-49).
- The opportunity structure and social networks available to metropolitan young people were qualitatively different and provided greater access to training than those in provincial settings (p. 49).
- Some accounts bore relation to research into VET in the 1980s suggesting black students were less likely to have direct proximity to 'real' workplaces — socially and culturally distanced from the workplace (p. 49).

## Connections

**Concepts:** [Vocationalism](../concepts/vocationalism.md) · [Apprenticeship](../concepts/apprenticeship.md) · [Social Justice](../concepts/social-justice.md) · [Social Capital](../concepts/social-capital.md) · [Widening Participation](../concepts/widening-participation.md)
**Authors:** [James Avis](../authors/avis.md) · [Kevin Orr](../authors/orr-kevin.md) · [Paul Warmington](../authors/warmington.md)
