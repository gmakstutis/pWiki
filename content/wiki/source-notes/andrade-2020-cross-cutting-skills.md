...
- Cross-cutting skills are not discipline or career specific, can and should be developed within educational settings, and prepare individuals for lifelong learning (p. 166).
- The key elements of high impact practices (Kuh & O'Donnell, 2013) are a helpful guiding framework: interactions with faculty and peers, frequent and constructive feedback, significant investment of time, high performance expectations, experiences with diversity, structured reflection, real-world application, and public demonstration of competence (p. 166).
- Groups and teams differ: in groups members share information and are individually accountable, while in teams members have a common purpose, focus on collective performance, and are mutually accountable (p. 168).
- Rubrics support the HIP element of frequent, timely, and constructive feedback, and focus conversations between instructors and students on learning as opposed to grades (p. 171).
- Self-regulated learning emphasizes responsibility for controlling the factors and conditions that impact learning; its six dimensions are motive, methods, time, physical environment, social environment, and performance (p. 173-174).
- The theory of transactional distance holds that providing structure and dialogue encourages learner autonomy (p. 174-175).
- UNESCO's four pillars of learning (learning to know, do, live together, and be) provide a means of understanding and categorizing students' learning outcomes (p. 175).
- The POLC framework (planning, organizing, leading, controlling) can be used to analyze learning outcomes in management contexts (p. 176).

## Connections

**Concepts:** [Cross-Cutting Skills](../concepts/cross-cutting-skills.md) · [High Impact Practices](../concepts/high-impact-practices.md) · [Self-Regulated Learning](../concepts/self-regulated-learning.md) · [Feedback](../concepts/feedback.md)
**Authors:** [Maureen Snow Andrade](../authors/andrade.md)
**Debates:** [Generic vs Domain-Specific Skills](../debates/generic-vs-domain-specific-skills.md)
