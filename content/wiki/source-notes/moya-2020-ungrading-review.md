...
- Grades promote academic performance — rather than learning (p. 2).
- A culture that promotes extreme attention to achievement could push some students to cut corners and compromise their process, connecting to academic integrity (p. 2).
- Grades have been used as a tool for segregation and can also become a control form, incentivizing students' work to meet requirements instead of expanding their knowledge, practice, or values from intrinsic motivation (p. 2).
- The authors explain alternative approaches, including pass/fail systems, students' assigning grades, and grade abolition (p. 2).
...
- It requires constant collaboration, negotiation, and consensus among main stakeholders (p. 2).
- The current wave of scientific managerialism relies on quantitative measures, for instance, in students' enrollment and funding allocation (p. 3).
- The book is "a contribution toward the structural change that will make schools about rewarding students with learning" (Blum, 2020, p. 227) (p. 3).
...
**Authors:** [Susan Blum](../authors/blum.md)
