...
- Criticism of grades, whether number/letter, encourages surface learning and memorising for the sake of achieving 'good' or 'better' grades (Butler & Nisan, 1986) (p. 4).
- Current grading and assessment practices may not accurately represent students' creativity or subject knowledge (Orr, 2010a), reflect bias (Cowdroy & Williams, 2007), contribute to a culture of competition over collaboration, reduce creativity and critical thinking, and encourage extrinsic motivation whilst diminishing intrinsic motivation (p. 5).
- Inclusive assessment is defined as 'the design and use of fair and effective assessment methods and practices that enable all students to demonstrate to their full potential' (Hockings, 2010) (p. 5-6).
- Ungrading and pass/fail emphasises feedback, self-reflection, and autonomy over assigning letter/numerical grades (Blum, 2020) (p. 6).
- Creating the grading conditions for autonomy, choice, reflection, and critical thinking are key to developing an intrinsic behaviour and growth mindset in students (Dweck, 2014) (p. 6).
- Assessment can be a context dependent, socially situated, and interpretive activity; requiring a connoisseurship with expertise built on experience and tacit knowledge (Shay, 2005; Orr, 2010b) (p. 7).
- The quality of creative outputs can be assured through inclusive practices; including transparent and explicit learning outcomes, constructive alignment (Biggs, 2003), feed-forward assessment feedback, and criteria-based marking rubrics (p. 8).
- There is a clear relationship between mental health, motivation, and mindset; poor mental health contributes to students prioritising grades even if this has the potential of contributing towards diminished motivation levels (p. 17).
- Students are motivated by a desire to develop their own artistic skills and understanding (65% of survey respondents) (p. 20).
- 'Assessment literacy is the most important thing that you can do in terms of helping students to understand... the learning outcomes and... what each band of grade means for each student' (Participant 2) (p. 20).
- 'Assidere' is the Latin root for the word assessment, and it actually means 'to sit beside' (Participant 5) (p. 22).

## Connections

**Concepts:** [Inclusive Assessment](../concepts/inclusive-assessment.md) · [Ungrading](../concepts/ungrading.md) · [Assessment](../concepts/assessment.md) · [Feedback](../concepts/feedback.md) · [Mindset](../concepts/mindset.md) · [Constructive Alignment](../concepts/constructive-alignment.md)
**Authors:** [Alex Bell](../authors/bell.md) · [Susan Blum](../authors/blum.md) · [Susan Orr](../authors/orr-susan.md) · [John Biggs](../authors/biggs.md) · [Carol Dweck](../authors/dweck.md)
