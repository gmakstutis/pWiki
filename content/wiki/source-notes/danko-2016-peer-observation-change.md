...
- POT is a reflection on teacher's work and how its results could influence student learning (p. 2).
- POT can establish a 'safe' place where discussions about teaching can take place (Gosling) (p. 2).
- The activity of observation in POT process could be just as beneficial as receiving feedback (p. 2).
- POT strengthens the self-efficacy of teachers to apply new strategies to their own teaching (Hendry and Oliver) (p. 2).
- The peer review model was adopted and designed as a three-part activity: pre-observation session, observation and post-observation reflective session (Martin and Double) (p. 3).
- The model is based on collegial observation with the purpose of describing observations rather than evaluating the teaching and learning process (p. 3).
- Students are most motivated in teaching and learning process when practical examples from everyday life linked with theory are made (p. 6).
- Students tend to disconnect from the lecture if the pace of a lecture is too fast for them (p. 6).
...
- Voluntary POT can grow into a lasting 'critical' friendship, and can become teacher's constant companion through their academic career (p. 6).

## Connections

**Concepts:** [Peer Observation](../concepts/peer-observation.md) · [Professional Development](../concepts/professional-development.md) · [Feedback](../concepts/feedback.md) · [Reflective Practice](../concepts/reflective-practice.md) · [Student Engagement](../concepts/student-engagement.md)
**Authors:** [Manica Danko](../authors/danko.md) · [David Gosling](../authors/gosling.md)
