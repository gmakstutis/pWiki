...
- Four overarching themes have emerged in the rationale for CBME: a focus on outcomes, an emphasis on abilities, a de-emphasis of time-based training, and the promotion of learner-centredness (p. 639).
- CBME is organized around the question, 'What abilities are needed of graduates?' (p. 642).
- The concept of competence as an ever-changing, contextual construct is emphasized, rather than a static concept that postulates a physician who, once certified to practise, is competent forever (p. 641).
- The term 'competent' should be used with modifiers that specify which domains of ability, which context, and what stage of medical education or practice it refers to (p. 641).
- Entrustable professional activities are essentially competencies in context; that is, an integration of the competencies that allow one to perform the professional activities expected of a good doctor within a given specialty (p. 641).
- Among the potential perils of CBME are: the threat of reductionism, promoting the lowest common denominator, logistical chaos, loss of authenticity, the tyranny of utility, the need for new educational technologies, and inertia and lack of resources (p. 642-643).
- CBME has the potential to transform how we prepare the physicians of the next decade (p. 643).

## Connections

**Concepts:** [Competency-Based Education](../concepts/competency-based-education.md) · [Learning Outcomes](../concepts/learning-outcomes.md) · [Assessment](../concepts/assessment.md) · [Cross-Cutting Skills](../concepts/cross-cutting-skills.md)
**Authors:** [Jason Frank](../authors/frank.md)
