...
- Central to firms' ability to recoup costs is the amount of time apprentices spend in directly productive activities (p. 6).
- Swiss firms recouped €54,400 cost with benefits of €57,100, while German firms experienced €46,600 cost but realized only €24,000 in benefits (p. 4).
- Nearly all German firms with apprenticeships (93%) incurred net costs, while most Swiss firms (60%) more than recouped their costs (p. 4).
- German firms offset higher in-program costs through higher retention of apprentices (50% vs 36% in Switzerland), aided by a more regulated labor market (p. 4-5).
- After 2003 German labor market reforms, firms adapted by increasing apprentices' involvement in production, reducing average net costs by 36% (p. 5).
- Apprenticeships create "real options" — firms have the option, not obligation, to hire trained workers, valuable under production uncertainty (p. 7).
- Well-trained workers are more likely to identify and implement technological improvements, linking in-company training to subsequent innovation (p. 7).
- Human capital investments are not treated like physical investments on balance sheets, so managers may underestimate gains; ISO 30414 provides guidelines for human capital reporting (p. 8).
- Only one in four employers regarded "poaching" as a serious problem; even among the most concerned, 85% still highly recommend apprenticeships (p. 7).

## Connections

**Concepts:** [Apprenticeship](../concepts/apprenticeship.md) · [Work-Based Learning](../concepts/work-based-learning.md) · [Human Capital](../concepts/human-capital.md)
**Authors:** [Robert Lerman](../authors/lerman.md)
**Debates:** [General vs Firm-Specific Training](../debates/general-vs-firm-specific-training.md)
