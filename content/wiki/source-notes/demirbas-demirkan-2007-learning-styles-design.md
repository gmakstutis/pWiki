...
- The most important learning experience comes from self-reflection, a skill central to the acquisition of all design knowledge and skills (p. 346).
- Design students were found to be more concentrated in assimilating and converging groups (p. 356).
- The learning style preferences did not significantly differ by gender in all three groups (p. 354).
- The performance scores of males were higher in technology-based courses, whereas scores of females were higher in artistic and fundamental courses and in the semester academic performance scores (GPA) (p. 356).
- The performance scores of converging and diverging students differed significantly in favor of converging students only in design courses (p. 356).
- Since design is considered as a problem solving activity, the converger learners are successful in design process (p. 357).
- Diverger learners are interested in gathering information and are more creative compared to the others, but they are not systematic in problem solving (p. 357).
...
- The design studio projects should provide the opportunity to employ different learning styles in design process (p. 357).

## Connections

**Concepts:** [Design Education](../concepts/design-education.md) · [Learning Styles](../concepts/learning-styles.md) · [Experiential Learning](../concepts/experiential-learning.md) · [Reflective Practice](../concepts/reflective-practice.md) · [Problem Solving](../concepts/problem-solving.md)
**Authors:** [O. Osman Demirbas](../authors/demirbas.md) · [David Kolb](../authors/kolb.md) · [Donald Schön](../authors/schon.md)
