...
- As of 2009, there was little evidence that learning style-based instruction improves student learning (p. 5).
- Riener and Willingham (2010) classify learning styles as a myth, contending that there is no credible evidence that learning styles exist (p. 5).
- The more methodologically sound studies have tended to refute the hypothesis (p. 1).
- Only two studies (Hsieh et al., 2011; Hung, 2012) reported an interaction effect supporting the matching hypothesis, and neither incorporated the ubiquitous VAK/VARK model (p. 21).
- Six studies tested the matching hypothesis in search of an interaction effect yet were unable to find one, and these studies tended to be stronger in their designs than those that produced positive results (p. 21).
- There is a total absence of evidence that the implementation of the VAK/VARK framework has any benefit whatsoever to students' academic learning (p. 21).
- Learning styles, if they are a valid construct, represent a preference while cognitive abilities represent a capacity or proficiency (p. 21).
...
- The general teacher education texts almost universally portrayed learning styles in a positive light and advocated for learning styles-based instruction, yet almost universally failed to cite any empirical research to support their claims (p. 9-10).

## Connections

**Concepts:** [Learning Styles](../concepts/learning-styles.md) · [Matching Hypothesis](../concepts/matching-hypothesis.md) · [Deep Learning](../concepts/deep-learning.md) · [Surface Learning](../concepts/surface-learning.md)
**Authors:** [Joshua Cuevas](../authors/cuevas.md) · [David Kolb](../authors/kolb.md)
